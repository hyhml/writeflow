...
def test_rejects_any_dimension_below_five():
    result = QualityGate().evaluate(scores([5, 4.9, 10, 10]))
...
def test_passes_only_when_all_dimensions_reach_five():
    result = QualityGate().evaluate(scores([5, 5, 5, 5]))
...
def test_high_total_score_no_longer_overrides_shallow_dimension():
    result = QualityGate().evaluate(scores([10, 10, 10, 4.9]))
...
def test_excellent_dimensions_no_longer_override_shallow_dimension():
    result = QualityGate().evaluate(scores([9, 4.9, 4.9, 4.9]))
...
def test_missing_depth_question_blocks_passing_scores():
...
def test_not_deep_enough_depth_question_no_longer_blocks():
    result = QualityGate().evaluate(
        scores([5, 5, 5, 5]),
        depth_questions=[
            {
